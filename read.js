...
// for (let i = 1; i <= 3; i++) {
//     console.log(`I'm going to do ${i} repetitions`);
// };


// const arr = [3, 5, 6, 1, 9, 4, 11]
// Looping Arrays, breaks and continuing

// for (let i = 0; i < 7; i++) {
//     console.log(arr[i]);
// }; // For cases we know when the array ends
...
// };
// // That last console.log with typeof will print the array containing what kindof value is example 3 -> 'String'


// // By creating an empty array and adding inside the typeof will not print the numbers, instead you'll get only what value type are
// const types = [];
// for (let i = 0; i < arr.length; i++) {
...
// // To add the ages of certain people into a new array will be like
// const years = [1991, 2000, 1999, 1970];
// const ages = [];
...
// // CONTINUE
// // If we have an array that we only want to print strings
// const arro = ['Edgar', 88, 55, 'Carlo', 'Mexico', 99]
// for (let i = 0; i < arro.length; i++) {
//     if (typeof arro[i] !== 'string') continue;
//     console.log(arro[i], typeof arro[i]);
// };

// // // BREAK
// for (let i = 0; i < arro.length; i++) {
//     if (typeof arro[i] === 'number') break;
//     console.log(arro[i])
// }
